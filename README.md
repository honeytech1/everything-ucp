...
**Universal Commerce Protocol (UCP)** is an **open-source protocol** that standardizes how AI agents, merchants, platforms, and payment systems interact across the full commerce lifecycle — from product discovery to post-purchase support.
...
Without UCP:
- ❌ Custom integration for ChatGPT
- ❌ Custom integration for Google Gemini  
- ❌ Custom integration for Microsoft Copilot
...
```
User searches → Clicks link → Browses site → Adds to cart → Checkout
```
...
|-|--|
| **Product Discoverability** | Standardized capability discovery via `/.well-known/ucp.json` |
...
* 📚 **[Main Repository](https://github.com/Universal-Commerce-Protocol/ucp)** - Specification and documentation (1.6k+ ⭐)
* 🐍 **[Python SDK](https://github.com/Universal-Commerce-Protocol/python-sdk)** - Official Python library (42+ ⭐)
* 📇 **[Samples](https://github.com/Universal-Commerce-Protocol/samples)** - Reference implementations (65+ ⭐)
* ✅ **[Conformance Tests](https://github.com/Universal-Commerce-Protocol/conformance)** - Validation suite

### Community & Support

* 💬 **[GitHub Discussions](https://github.com/Universal-Commerce-Protocol/ucp/discussions)** - Community Q&A
* 🐛 **[Issue Tracker](https://github.com/Universal-Commerce-Protocol/ucp/issues)** - Bug reports and feature requests
* 📧 **[Merchant Waitlist](https://developers.google.com/merchant/ucp)** - Early access to Google integration
...
## 🛠️ Implementations & SDKs

### Official SDKs

#### Python SDK (Official) ⭐
**Repository:** [Universal-Commerce-Protocol/python-sdk](https://github.com/Universal-Commerce-Protocol/python-sdk) (42+ ⭐)
...
#### Python/FastAPI Server (Official)
...
**Documentation:** [Shopify Agentic Commerce](https://www.shopify.com/news/ai-commerce-at-scale)
...
* **[UCP Playground](https://ucp.dev/playground)** - Interactive testing environment
* **[Conformance Suite](https://github.com/Universal-Commerce-Protocol/conformance)** - Validation testing
* **[Schema Validator](https://ucp.dev/specification/reference/)** - API schema validation
...
**Direct Checkout in AI Conversations**
- Purchase products without leaving AI Mode or Gemini
...
- Shop from multiple retailers in single conversation
- Unified checkout experience
- Universal Cart via Shopify

**Order Tracking**
- Real-time order status updates
- Post-purchase support in AI context
...
**What it does:** Enables AI model interactions and context transport  
...
**What it does:** Secure payment protocol with cryptographic consent  
...
**What it does:** Protocol for agent-to-agent communication  
**UCP Integration:** Supported transport method  
**Use case:** Direct agent-to-merchant messaging
...
### Co-Developers (Built UCP)

| Company | Role | Website |
||||
| **Google** | Lead Developer | [google.com](https://google.com) |
| **Shopify** | Co-Developer, Infrastructure | [shopify.com](https://shopify.com) |
| **Etsy** | Co-Developer, Marketplace | [etsy.com](https://etsy.com) |
| **Wayfair** | Co-Developer, Home Goods | [wayfair.com](https://wayfair.com) |
...
**Option A: Platform-Based (Easiest)**
- Use Shopify Agentic Storefronts
- Automatic deployment to Google, ChatGPT, Copilot
- Managed through Shopify Admin
- **Best for:** Shopify merchants

**Option B: Direct Integration (Most Control)**
- Implement UCP endpoints directly
...
1. Join [Google Merchant Waitlist](https://developers.google.com/merchant/ucp)
2. Configure Merchant Center
3. Submit for review
4. Launch on AI surfaces
...
**The Complete Stack:**
```
Content Layer: [Uttik](https://uttik.com) AEO Platform
     ↓
...
1. **Optimize for Discovery** ([Uttik](https://uttik.com) handles this)
...
3. **Follow the format** (check existing entries)
...
- Verified implementation guides
- Real case studies
...
This UCP Resources Hub is provided by [Uttik](https://uttik.com) under **CC0 1.0 Universal** - public domain dedication.
...
UCP itself is licensed under **Apache License 2.0**.
